...
import com.sunsafe.app.di.DatabaseModule;
import com.sunsafe.app.di.NetworkModule;
import com.sunsafe.app.di.RepositoryModule;
...
import com.sunsafe.app.service.ExposureTrackingService_GeneratedInjector;
import com.sunsafe.app.worker.ExposureTrackingWorker_HiltModule;
import com.sunsafe.app.worker.ReminderWorker_HiltModule;
import com.sunsafe.app.worker.UvDataRefreshWorker_HiltModule;
import dagger.Binds;
...
public final class SunSafeApplication_HiltComponents {
  private SunSafeApplication_HiltComponents() {
  }
  ...
  @Component(
      modules = {
          ...
          ExposureTrackingWorker_HiltModule.class,
          ...
          UvDataRefreshWorker_HiltModule.class
      }
  )
  @Singleton
  public abstract static class SingletonC implements SunSafeApplication_GeneratedInjector,
  ...
  @Subcomponent
  @ServiceScoped
  public abstract static class ServiceC implements ExposureTrackingService_GeneratedInjector,
      ServiceComponent,
      GeneratedComponent {
